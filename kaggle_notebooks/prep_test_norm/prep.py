...
Xuat /kaggle/working/hodc_test_norm/images/<id>.tif + meta.csv
"""
import os, glob, time
import numpy as np
import pandas as pd
...
OUT = "/kaggle/working/hodc_test_norm"
GAIN = 114.0 / 44.1
...
def soft_spectral_norm(cube):
    ...
    return cube * ((114.0 + C_SOFT) / (m + C_SOFT))   # PHAI giong het prep_train, neu khac la lech phan phoi train/test
